...
// CarregarPaginaDeUsuarios carrega a página com os usuráios que atendem o filtro passado
...
// CarregarPerfilDoUsuario carrega a página de perfil do usuário
func CarregarPerfilDoUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID == usuarioLogadoID {
		http.Redirect(w, r, "/perfil", http.StatusMovedPermanently)
		return
	}
...
// CarregarPaginaDeEdicaoDeUsuario carrega a pagina para editar os dados do usuario
...
// CarregarPaginaDeAtualizacaoDeSenha carrega a pagina para atualizaação de senha do usuário
func CarregarPaginaDeAtualizacaoDeSenha(w http.ResponseWriter, r *http.Request) {
	utils.ExecutarTemplate(w, "atualzar-senha.html", nil)
}

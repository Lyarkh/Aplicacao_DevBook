...
// BuscarDadosDoUsuario chama a API paras buscar os dados base do usuário
...
// BuscarSeguindo chama a API para buscar os usuarios seguidos pelo usuario
...
// BuscarPublicacoes chama a API para buscar as publicacões de um usuario

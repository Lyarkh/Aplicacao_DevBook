...
// CurtirPublicacao adiciona uma curtida em uma publicação especificada pelo ID
...
// DescurtirPublicacao retira uma curtida em uma publicação especificada pelo ID
